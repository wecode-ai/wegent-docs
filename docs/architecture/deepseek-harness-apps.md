...
flowchart LR
    ...
    NODE --> RUNTIME[Single-file Wework-managed DSH runtime archive]
...
| Runtime archive, content fingerprint, macOS pre-signing, Node JIT signing, and checks | `wework/scripts/prepare-deepseek-harness-runtime.mjs`, `wework/scripts/lib/deepseek-harness-signing.mjs`, `wework/scripts/deepseek-harness-node.entitlements.plist`, `wework/src-tauri/tauri.conf.json` |
