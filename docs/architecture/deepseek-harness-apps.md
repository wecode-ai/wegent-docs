...
flowchart LR
    ...
    NODE --> RUNTIME[Fingerprint-named harness-runtime release asset]
...
| Runtime release asset, descriptor, fingerprint, macOS pre-signing, and Node JIT checks | `wework/scripts/prepare-harness-runtime.mjs`, `wework/scripts/lib/deepseek-harness-signing.mjs`, `wework/scripts/deepseek-harness-node.entitlements.plist` |
