...
flowchart LR
    ...
    SIGN --> RUNTIME[Wework 管理的单文件 DSH Runtime 归档]
...
| Runtime 归档、内容指纹、macOS 预签名和构建准备 | `wework/scripts/prepare-deepseek-harness-runtime.mjs`、`wework/scripts/lib/deepseek-harness-signing.mjs`、`wework/src-tauri/tauri.conf.json` |
